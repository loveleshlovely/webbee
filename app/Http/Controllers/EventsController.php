...
class EventsController extends BaseController
{
    ...
    public function getEventsWithWorkshops() {
        $events = Event::get(); // Get all the data from event table
        foreach ($events as $key => $getEvent) { // run loop for get or arrange
            $events[$key]['workshops'] = Workshop::where('event_id' , $getEvent->id)->get(); //storing workshops in new event key
        }
        return $events;
    }
    ...
    public function getFutureEventsWithWorkshops() {
        ...
        $events = Event::select('events.*')
                        ...
                        ->whereDate('workshops.start' , '>' , $date)
                        ->groupBy('workshops.event_id')
                        ->get(); // Get all the data from event table
